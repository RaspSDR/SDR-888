...
void MainWindow::init() {
    ...
    std::string modulesDir = modulesDirectory;
    std::string resourcesDir = resourcesDirectory;
...
void MainWindow::draw() {
    ...
    if (ImGui::ImageButton("menu_btn", icons::MENU, btnSize, ImVec2(0, 0), ImVec2(1, 1), ImVec4(0, 0, 0, 0), textCol) || ImGui::IsKeyPressed(ImGuiKey_Menu, false)) {
        showMenu = !showMenu;
        core::configManager.acquire();
    ...
    if (playing) {
        ...
        if (ImGui::ImageButton("stop_btn", icons::STOP, btnSize, ImVec2(0, 0), ImVec2(1, 1), ImVec4(0, 0, 0, 0), textCol) || ImGui::IsKeyPressed(ImGuiKey_End, false)) {
            setPlayState(false);
        }
        ImGui::PopID();
    }
        ...
        if (ImGui::ImageButton("play_btn", icons::PLAY, btnSize, ImVec2(0, 0), ImVec2(1, 1), ImVec4(0, 0, 0, 0), textCol) || ImGui::IsKeyPressed(ImGuiKey_End, false)) {
            setPlayState(true);
        }
        ImGui::PopID();
    }
    ...
    if (tuningMode == tuner::TUNER_MODE_CENTER) {
        ...
        if (ImGui::ImageButton("ena_st_btn", icons::CENTER_TUNING, btnSize, ImVec2(0, 0), ImVec2(1, 1), ImVec4(0, 0, 0, 0), textCol)) {
        ...
        if (ImGui::ImageButton("dis_st_btn", icons::NORMAL_TUNING, btnSize, ImVec2(0, 0), ImVec2(1, 1), ImVec4(0, 0, 0, 0), textCol)) {
    ...
    if (ImGui::ImageButton("logo_btn", icons::LOGO, ImVec2(32 * style::uiScale, 32 * style::uiScale), ImVec2(0, 0), ImVec2(1, 1))) {
        showCredits = true;
    }
    ...
    if (ImGui::VSliderFloat("##_9_", wfSliderSize, &fftMin, 0.0, -140.0f, "")) {
