...
namespace demod {
    ...
    public:
        ...
        void init(std::string name, ConfigManager* config, dsp::stream<dsp::complex_t>* input, double bandwidth, double audioSR) {
            ...
            // Define structure
            demod.init(input, dsp::demod::SSB<dsp::stereo_t>::Mode::LSB, agcEnable, gain, bandwidth, getIFSampleRate(), agcAttack / getIFSampleRate(), agcDecay / getIFSampleRate());
        }
        ...
        void showMenu() {
            ...
            if (agcEnable) {
                ...
                ImGui::SetNextItemWidth(menuWidth - ImGui::GetCursorPosX());
                if (ImGui::SliderFloat(("##_radio_lsb_gain_" + name).c_str(), &gain, 0.0f, 100.0f, "%.1f dB")) {
                    demod.setGainDb(gain);
                    _config->acquire();
